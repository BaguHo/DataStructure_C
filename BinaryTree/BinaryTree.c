...
// BTreeNode => void 로 바꾸어야 하는거 아닌가? 반환하는게 없는데 굳이
// BTreeNode타입으로 return 해야하나? MakeLeftSubNode, MakeRightSubNode,
...
Data GetData(BTreeNode *bt) { return bt->data; }

void SetData(BTreeNode *bt, Data data) { bt->data = data; }
